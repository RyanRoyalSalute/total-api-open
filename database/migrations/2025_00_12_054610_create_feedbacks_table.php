...
class CreateFeedbacksTable extends Migration
{
    public function up(): void
    {
        Schema::create('feedbacks', function (Blueprint $table) {
            ...
            $table->json('feedback_images')->nullable(); // 上傳花絮 (1~5 複數) URLs in the format: storage/Saabisu/feedback/fb[feedback pkey]_[1-5].png
        ...
        DB::table('feedbacks')->insert([
            [
                ...
                'feedback_images' => json_encode([
                    'storage/Saabisu/feedback/fb1_1.png',
                    'storage/Saabisu/feedback/fb1_2.png',
                    'storage/Saabisu/feedback/fb1_3.png',
                    'storage/Saabisu/feedback/fb1_4.png',
                    'storage/Saabisu/feedback/fb1_5.png'
                ]),
                'sort' => 0,
                'status' => 1,
                'created_at' => now(),
            ...
            [
                ...
                'feedback_images' => json_encode([
                    'storage/Saabisu/feedback/fb2_1.png',
                    'storage/Saabisu/feedback/fb2_2.png'
                ]),
                'sort' => 0,
                'status' => 1,
                'created_at' => now(),
            ...
            [
                ...
                'feedback_images' => json_encode([
                    'storage/Saabisu/feedback/fb3_1.png'
                ]),
                'sort' => 0,
                'status' => 1,
                'created_at' => now(),
